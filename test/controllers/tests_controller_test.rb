...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { test_description: @test.test_description, test_name: @test.test_name } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { test_description: @test.test_description, test_name: @test.test_name } }
