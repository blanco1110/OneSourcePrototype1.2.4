...
class DeviceManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create device_manufacturer" do
    assert_difference('DeviceManufacturer.count') do
      post device_manufacturers_url, params: { device_manufacturer: { device_manu_name: @device_manufacturer.device_manu_name } }
    end
  ...
  test "should update device_manufacturer" do
    patch device_manufacturer_url(@device_manufacturer), params: { device_manufacturer: { device_manu_name: @device_manufacturer.device_manu_name } }
