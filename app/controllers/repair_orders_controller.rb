class RepairOrdersController < ApplicationController
  ...
  private
    ...
    def repair_order_params
      params.require(:repair_order).permit(:repair_order_date, :repair_order_subtotal, :repair_order_tax, :repair_order_total, :repair_order_accessories, :repair_order_notes, :repair_order_status_id, :repair_order_status_date)
    end
end
